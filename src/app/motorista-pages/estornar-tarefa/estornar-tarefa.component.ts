...
@Component({
  selector: 'app-estornar-tarefa',
  templateUrl: './estornar-tarefa.component.html',
  styleUrls: ['./estornar-tarefa.component.scss'],
...
export class EstornarTarefaComponent {
  //Injeções
  ...
  estornarEvento() {  
    ...
    if (this.tarefaAtualIndex < this.tarefas.length) {
      ...
      tarefaAtual.cancelado = true;
  
      // Limpa os campos da tarefa atual
      this.limparCamposTarefa(tarefaAtual);
  ...
  // Método para limpar os campos da tarefa
  private limparCamposTarefa(tarefa: any) {
    tarefa.horaInicio = null; // Limpa o campo horaInicio
    tarefa.horaFim = null; // Limpa o campo horaFim
    tarefa.horarioInicio = null; // Limpa o campo horarioInicio
    tarefa.horarioFim = null; // Limpa o campo horarioFim
    tarefa.evento = ''; // Limpa o campo evento
    tarefa.hodometro = null; // Limpa o campo hodometro
    tarefa.catraca = null; // Limpa o campo catraca
    tarefa.cancelado = true;
  
    // Atualiza o formulário para refletir os campos limpos
    this.formGroup.patchValue({
      horaInicio: null,
      horaFim: null,
      horarioInicio: null,
    ...
    console.log('Campos da tarefa limpos:', tarefa);
  }
